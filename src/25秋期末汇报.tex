...
\title{强基期末汇报}
\author[陈骁睿]{\texorpdfstring{陈骁睿\\导师：张学锋}{陈骁睿}}
\date{\today}
\institute{重庆大学物理学院}
\begin{document}
...
\begin{frame}
  \frametitle{大四阶段}
  \begin{itemize}
    \item 课程方面：大四上已完成所有本科选修课程。在下学期提前学习研究生课程。
    \item 科研方面：继续量子蒙特卡洛算法的研究，并以此作为毕业设计。
...
\begin{frame}
  \frametitle{after PhD}
  \begin{itemize}
    \item  强：找个好地方做博后，多卷文章，最后希望待在科研界。
    \item  弱：找个小厂码码，或回家找个二本躺平。
  \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{总结与感悟}
  \begin{itemize}
    \item 三年半过得挺快，从刚进校的迷茫，到慢慢适应强基的节奏，成绩、科研、竞赛、辅修一起上，虽然有时候很累，但回头看还是挺充实的。
    \item 物理专业课加上计算机辅修，让我意识到理论和代码可以互相成就，做项目、写程序的时候，第一次真切感觉到学过的东西是可以“跑起来”的。
    \item 接下来想在量子蒙特卡洛和并行计算方向多下点功夫,并解决真正物理上的问题，多和老师、师兄师姐交流，哪怕走得慢一点，也希望自己能稳稳地留在科研这条路上。
  \end{itemize}
\end{frame}
